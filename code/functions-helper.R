...
anthro_make_grouping_label <- function(other_grouping_name) {
  if (
    !is.character(other_grouping_name) ||
  ...
  tryCatch(
    {
      ...
      res <- try(suppressMessages(read.csv(
        path,
...
# This is a workaround for shinylive and chromium
# see https://shinylive.io/r/examples/#r-file-download
