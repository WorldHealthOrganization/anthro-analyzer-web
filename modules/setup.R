...
SetUp <- function(input, output, session, panel_main, original_filename) {
  ...
  list_variables_input <-
    list(
      ...
      "id_variables_weight",
      "id_variables_lenhei",
      "id_variables_lenhei_unit",
      "id_variables_oedema",
      "id_variables_sw",
      "id_variables_team",
      "id_variables_cluster",
      "id_variables_strata",
      "id_variables_typeres",
      "id_variables_gregion",
      "id_variables_wealthq",
      "id_variables_mothered",
      "id_variables_othergr"
    )
    ...
    tagList(
      ...
      conditionalPanel(
        ...
        list(
          ...
          checkboxInput(
            "compute_age",
            "Compute age using Date of birth and Date of visit",
            TRUE
          ),
          conditionalPanel(
            ...
            tagList(
              selectInput(
                "date_format",
                "Date format",
                choices = c("dd/mm/yyyy", "mm/dd/yyyy")
              ),
