# Anthro Survey Analyser (development)
* Various improvements and bug fixes.
* The z-score and prevalence computation is now based on the anthro R package.
* Moved to shinylive as the main distribution method.
